...
export const Header = () => (
  <header className="container relative z-50 mx-auto text-sm font-semibold leading-6">
    <nav>
      <div className="relative flex items-center px-4 py-8">
        <div className="absolute inset-x-0 bottom-0 h-px bg-slate-900/5"></div>
        <NavLink className="flex-none text-slate-900" to="/">
        ...
        <div className="ml-auto hidden lg:flex lg:items-center">
          <a className="ml-8" href="/products/list">
            Products
          </a>
        </div>
        <button
        ...
        <div className="hidden lg:ml-8 lg:flex lg:items-center lg:border-l lg:border-gray-900/15 lg:pl-8">
          <a href="#">Sign in</a>
        </div>
      </div>
    </nav>
